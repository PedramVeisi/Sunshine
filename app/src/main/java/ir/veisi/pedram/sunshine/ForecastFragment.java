package ir.veisi.pedram.sunshine;
...
public class ForecastFragment extends Fragment {
    ...
    // AsyncTask to fetch JSON data from the server
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]>{
        ...
        protected String[] doInBackground(String... params) {
            ...
            String requestedDataFormat = "json";
            ...
            try {
                ...
                Uri buildUri = Uri.parse(FORECAST_BASE_URL).buildUpon()
                        ...
                        .appendQueryParameter(FORMAT_PARAM, requestedDataFormat)
                        .appendQueryParameter(UNITS_PARAM, requestedUnits)
